...
#' colloc <- collocation(x, term = "lemma", group = c("doc_id", "sentence_id"), ngram_max = 3, n_min = 10)
#' head(colloc, 10)
#' 
...
#' colloc <- collocation(x, term = "lemma", group = c("doc_id", "sentence_id"), ngram_max = 2, n_min = 2)
#' head(colloc)
