...
str(annotation_params$tokenizer, 3)
## Example for training the tokenizer on the Dutch treebank
hyperparams_nl <- subset(annotation_params$tokenizer, language_treebank == "nl")
...
hyperparams_nl <- subset(annotation_params$tagger, language_treebank == "nl")
as.list(hyperparams_nl)
```
...
hyperparams_nl <- subset(annotation_params$parser, language_treebank == "nl")
as.list(hyperparams_nl)
```
